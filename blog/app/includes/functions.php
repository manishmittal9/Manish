...
//  uses the glob function to find all the posts
...
// It takes the list of names returned by get_post_names() and parses the files.
// It uses the Markdown library to convert them to HTML
...
// The not found error
// It is a wrapper around Dispatch’s error function but renders a view as the message
function not_found(){
